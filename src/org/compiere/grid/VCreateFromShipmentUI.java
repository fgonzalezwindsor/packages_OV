...
public class VCreateFromShipmentUI extends CreateFromShipment implements ActionListener, VetoableChangeListener
{
    ...
    private void jbInit() throws Exception
    {
    	...
    	orderLabel.setText("OC/OV");//faaguilar OFB
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (e.getSource().equals(llegadaField))
		{
			...
			rmaField.setSelectedIndex(-1);
		    invoiceField.setSelectedIndex(-1);
			loadLlegada(OV_Llegada_ID, locatorField.getValue()!=null?((Integer)locatorField.getValue()).intValue():0);	
		}
	...
	protected void loadLlegada (int OV_Llegada_ID, int M_Locator_ID)
	{
		loadTableOIS(getLlegadaData(OV_Llegada_ID, M_Locator_ID));
	}
