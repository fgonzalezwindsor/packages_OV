...
import org.compiere.model.I_C_PaymentList;
import org.compiere.model.I_C_PaymentMassive;
import org.compiere.model.I_C_PaymentRequest;
...
public class VCreateFromFactory
{
	...
	static
	{
		...
		/**
		 * faaguilar OFB tables*/
		s_registeredClasses.put(I_C_Order.Table_ID, VCreateFromOrderUI.class);
		s_registeredClasses.put(I_C_PaymentMassive.Table_ID, VCreateFromPaymentMassiveUI.class);
		s_registeredClasses.put(I_C_PaymentRequest.Table_ID, VCreateFromPaymentRequestUI.class);
